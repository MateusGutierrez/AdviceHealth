              ...
              <Card id="reminder">
                ...
                {isEmpty(reminders) ? (
                  ...
                  map(reminders, (reminder, index) => {
                    return <Typography key={index}>{reminder}</Typography>;
                  })
                )}
              </Card>
              <div id="statistics">
                <Card>
                  <CardContent className="d-flex justify-content-between">
                    ...
                    <Typography>
                      {' '}
                      R$ {statistic?.dailyRevenue ?? 'Waiting Payment'}
                    </Typography>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="d-flex justify-content-between">
                    ...
                    <Typography>
                      {statistic?.patientsServedToday ??
                        scheduleData?.dailySchedule.length}{' '}
                ...
                <Card>
                  <CardContent className="d-flex justify-content-between">
                    ...
                    <Typography>
                      {statistic?.appointmentsToday ??
                        scheduleData?.dailySchedule.length}
                      <i className="bi bi-calendar-fill" id="calendar-icon" />
                    </Typography>
                  </CardContent>
                </Card>
              </div>
