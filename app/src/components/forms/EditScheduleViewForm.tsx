...
const ScheduleViewForm = ({hide, patientData}: Props) => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<AddPatientToScheduleFormValue>({
    ...
    return (
        <div>
          ...
          <StyledForm onSubmit={handleSubmit(onSubmit)}>
            ...
            <div id='date-address'>
                <div>
                    <Input type="date" placeholder='Birthdate' fullWidth {...register('birthdate')} />
            ...
            <div className="d-flex justify-content-center">
                <Button  type="submit" className='bg-primary text-light'>Update</Button>
            </div>
          </StyledForm>
        </div>
    )
